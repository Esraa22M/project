    ...
    return (
      <Router>
        ...
        <Routes>
          <Route
            path="/"
            element={<AllCategory category={items.categories[0]} />}
          ></Route>
          <Route path="/clothes" element={<ClothingCategory category={items.categories[1]} />}></Route>
          <Route path="/tech" element={<TechCategory  category={items.categories[2]} />}></Route>
