...
class ProductDetails extends React.Component {
  ...
  getSelectedProductSelectedAttributes = (obj) => {
    ...
    tempAttributesIndex[obj.index]=true;
                  ...
                  item.type !== "swatch"
                    ? item.items.map((item, index) => {
                        return (
                          <ButtonDefault
                            key={index}
                            className={this.state.activeButtonIndex===index&&this.state.AttributeIndex[getTopIndex]===true?"activeButton":""}
                            onClick={() =>
                    ...
                    : item.items.map((item, index) => {
                        return (
                          <ButtonDefault
                            key={index}
                            className={this.state.activeButtonSwatchIndex===index&&this.state.AttributeIndex[getTopIndex]===true?"activeSwatchButton":""}
