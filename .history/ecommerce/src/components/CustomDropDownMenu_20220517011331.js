        ...
        <div className="select">
          <div className="select__trigger">
            <div className="arrow" onClick={this.handleArrowFliping}>
              ...
              <span>
                <img src={downArrow} className={isFliped ? "rotate" : ""}  alt="cap-icon"/>
              </span>
            </div>
          </div>
          <div
            onMouseLeave={this.handleArrowFliping}
            className={["custom-options", isFliped ? "show" : ""].join(" ")}
          >
            <div
              ...
              onClick={(e) => {
                ...
                this.handleSelectedListItem(e);
                this.handleArrowFliping();
