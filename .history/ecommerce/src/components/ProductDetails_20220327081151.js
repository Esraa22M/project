...
class ProductDetails extends React.Component {
  constructor(props) {
    ...
    this.state = {
      ...
      isAddToCartButtonPressed:false
    };
  }
  ...
  checkIfAllAttributesSelected = (attributes , flag) => {
    let getAllAttributes = this.state.attributes;
    this.setState({isAddToCartButtonPressed:flag})
          ...
          <Column>
            ...
            <div>
              {product.inCart ? (
                ...
                <AddToCartButton
                  to={
                    this.checkIfAllAttributesSelected(product.attributes ,true)
                      ? "/cart"
              ...
              {this.checkIfAllAttributesSelected(product.attributes,false)&&this.state.isAddToCartButtonPressed ? (
                <></>
              ) : (
