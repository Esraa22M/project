...
class ProductDetails extends React.Component {
  ...
  getSelectedProductSelectedAttributes = (obj) => {
    ...
    this.setState({activeButtonSwatchIndex:-1});
    }else{
                  ...
                  item.type !== "swatch"
                    ? item.items.map((item, index) => {
                        return (
                          <ButtonDefault
                            key={index}
                            className={this.state.activeButtonIndex===index&&this.state.buttonType!='swatch'?"activeButton":""}
                            onClick={() =>
                    ...
                    : item.items.map((item, index) => {
                        return (
                          <ButtonDefault
                            key={index}
                            className={this.state.activeButtonIndex===index&&this.state.buttonType==='swatch'?"activeSwatchButton":""}
