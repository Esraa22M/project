...
class Cart extends React.Component {
  ...
  componentDidUpdate(prevProps) {
    if (
     ( JSON.stringify(this.props.itemsAddedToCart) !==
      ...
      (this.props.itemsAddedToCart.length)||(this.props.total!== prevProps.total)
    ) {
      this.props.getTotal();
      this.props.getTax();
  ...
  render() {
    let { itemsAddedToCart ,Tax, selectedCurrencyIndex} = this.props;
    return (
      <Container>
            ...
            <div key={index}>
              <ProductContainer key={index} className="flex flex-space-between">
                <div className="column flex-column ">
                    ...
                    <CartItemPrice>
                      <span>{item.prices[selectedCurrencyIndex].currency.symbol}</span>
                      <span>{item.prices[selectedCurrencyIndex].amount}</span>
                    </CartItemPrice>
                    <div>
