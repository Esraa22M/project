...
class ProductDetails extends React.Component {
  ...
  getSelectedProductSelectedAttributes = (obj) => {
    ...
    let tempAttributesIndex = [...this.state.AttributeIndex];
    tempAttributesIndex[obj.topIndex]=obj.topIndex;
    this.setState({AttributeIndex:tempAttributesIndex})
    }else{
                  ...
                  item.type !== "swatch"
                    ? item.items.map((item, index) => {
                        return (
                          <ButtonDefault
                            key={index}
                            className={this.state.activeButtonIndex===index&&this.state.AttributeIndex[getTopIndex]===getTopIndex?"activeButton":""}
                            onClick={() =>
                    ...
                    : item.items.map((item, index) => {
                        return (
                          <ButtonDefault
                            key={index}
                            className={this.state.activeButtonSwatchIndex===index&&this.state.AttributeIndex[getTopIndex]===getTopIndex?"activeSwatchButton":""}
