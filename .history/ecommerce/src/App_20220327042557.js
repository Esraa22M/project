...
import { OverLayDiv, MiniCart } from "./styles/Category.style";
          ...
          <Route
            ...
            element={
              ...
              handleCartIconClickToPopUpProduct={this.handleCartIconClickToPopUpProduct}
                products={items.categories[0].products}
                selectedCurrencyIndex={selectedCurrencyIndex}
          ...
          <Route
            ...
            element={
              ...
              handleCartIconClickToPopUpProduct={this.handleCartIconClickToPopUpProduct}
                ...
                products={items.categories[1].products}
                selectedCurrencyIndex={selectedCurrencyIndex}
                handleProductIdAndCategoryId={this.handleProductIdAndCategoryId}
              />
            }
          ...
          <Route
            ...
            element={
              ...
              handleCartIconClickToPopUpProduct={this.handleCartIconClickToPopUpProduct}
                ...
                products={items.categories[2].products}
                selectedCurrencyIndex={selectedCurrencyIndex}
                handleProductIdAndCategoryId={this.handleProductIdAndCategoryId}
              />
            }
